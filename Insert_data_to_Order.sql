...
INSERT INTO Orders(customer_id, bookstore_id, publisher_name, brach_name, date)
VALUES (3, null, null, null, "2019-10-10"),
		(3, null, null, null, "2019-09-09"),
        (3, null, null, null, "2019-08-08"),
        (3, null, null, null, "2019-07-07"),
        (null, 10, 1, 1, "2019-01-01"),
        (null, 10, 1, 1, "2019-02-02"),
        (null, 10, 1, 1, "2019-03-03"),
        (null, 10, 1, 1, "2019-04-04");
        
INSERT INTO Special_Order(order_id,customer_id)
VALUES (23,3),
		(24,3),
        (25,3),
        (26,3);
...
INSERT INTO Order_Book(order_id, ISBN, quantity, is_sold)
VALUES (23, '0-4809-1234-3', 1, 1),
		(24, '0-1188-0050-7', 1, 1),
        (24, '0-3432-6145-6', 1, 1),
        (25, '0-1188-0050-7', 1, 1),
        (26, '0-1188-0050-7', 1, 1),
        (26, '0-3432-6145-6', 1, 1),
        (27, '0-1188-0050-7', 20, 0),
        (28, '0-1188-0050-7', 10, 0),
        (29, '0-1188-0050-7', 15, 0),
        (30, '0-1188-0050-7', 12, 0);